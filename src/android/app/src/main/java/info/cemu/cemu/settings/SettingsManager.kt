...
class EmulationScreenSettings(
    ...
    companion object {
        ...
        private const val IS_PAD_VISIBLE_KEY = "IS_PAD_VISIBLE"
    }
    ...
    fun save(sharedPreferences: SharedPreferences) {
        sharedPreferences.edit().apply {
            ...
            putBoolean(IS_PAD_VISIBLE_KEY, isPadVisible)
            remove(ARE_SCREENS_SWAPPED_KEY)
            apply()
        }
    }
}
